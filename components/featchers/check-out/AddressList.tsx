...
export default function AddressList({ addresses, selectedId, onSelect }: Props) {
  return (
    <section className="bg-card rounded-2xl border border-border p-5 flex flex-col gap-4 shadow-sm">
      ...
      <button className="self-start flex items-center gap-2 px-4 py-2 rounded-xl border border-border text-sm font-semibold text-muted-foreground hover:text-foreground hover:border-foreground transition-all">
