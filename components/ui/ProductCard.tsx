...
export default function ProductCard({
  ...
  return (
    <div
      ...
      className="w-[280px] md:w-[320px] h-108 bg-card rounded-xl overflow-hidden border border-border shadow-sm group hover:shadow-md transition-all duration-300 cursor-pointer flex flex-col"
    >
      {/* Image */}
